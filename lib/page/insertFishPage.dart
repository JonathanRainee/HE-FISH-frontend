...
class _InsertFishPageState extends State<InsertFishPage> {
  ...
  void addFish() async{
    ...
    // req.files.add(await http.MultipartFile.fromPath('image', "http://10.0.2.2:3000/assets/bgss.jpg"));
    // req.fields["title"] = "123";
    // req.fields["filePath"] = image!.path;
    req.fields["filePath"] = "http://10.0.2.2:3000/assets/bgss.jpg";
    req.fields["userID"] = "1";
